...
TEST_DATA = [
  ...
  // critical trials
  {id: "trial1", id1: "if1_un_ind", id2: "if1_un", id3: "if2_unu", id0: "ant_u", property_id1: "contrast", property_id2: "exhaustive", property_id3: "non-exhaustive", question: QUESTS.if_ant, answer: ANSWERS.conditional, type: 'critical'},
  {id: "trial2", id1: "if1_un_ind", id2: "if1_un", id3: "if2_unu", id0: "cons_n", property_id1: "contrast", property_id2: "exhaustive", property_id3: "non-exhaustive", question: QUESTS.cons, answer: ANSWERS.conditional, type: 'critical'},
  {id: "trial3", id1: "if1_un_ind", id2: "if2_unn_horiz", id3: "if1_uu", id0: "ant_u", property_id1: "contrast", property_id2: "exhaustive", property_id3: "non-exhaustive", question: QUESTS.if_ant, answer: ANSWERS.conditional, type: 'critical'},

  {id: "trial4", id1: "if1_un_ind", id2: "if1_un", id3: "if1_uu", id0: "ant_u", property_id1: "contrast", property_id2: "exhaustive", property_id3: "non-exhaustive", question: QUESTS.if_ant, answer: ANSWERS.conditional, type: 'critical'},
  {id: "trial5", id1: "if1_un_ind", id2: "if2_unn_horiz", id3: "if2_unu", id0: "ant_u", property_id1: "contrast", property_id2: "exhaustive", property_id3: "non-exhaustive", question: QUESTS.if_ant, answer: ANSWERS.conditional, type: 'critical'},
  {id: "trial6", id1: "if1_un_ind", id2: "if2_unn_horiz", id3: "if2_unu", id0: "cons_n", property_id1: "contrast", property_id2: "exhaustive", property_id3: "non-exhaustive", question: QUESTS.cons, answer: ANSWERS.conditional, type: 'critical'},

  // practice trials
  {id: "trial7", id1: "if2_unn_horiz", id2: "if1_un", id3: "if2_unu", id0: "cons_n", property_id1: "contrast", property_id2: "", property_id3: "", question: QUESTS.neutral, answer: ANSWERS.conditional_all, type: 'practice'},
  {id: "trial8", id1: "if2_unu", id2: "if1_un", id3: "if1_uu", id0: "ant_u", property_id1: "contrast", property_id2: "", property_id3: "", question: QUESTS.neutral, answer: ANSWERS.conditional_only, type: 'practice'},
  {id: "trial9", id1: "if2_nnn_horiz", id2: "if2_unn_horiz", id3: "if2_unh", id0: "cons_n", property_id1: "contrast", property_id2: "", property_id3: "", question: QUESTS.neutral, answer: ANSWERS.yellow_cons, type: 'practice'},

  // balance trials
  {id: "trial10", id1: "if1_un_ind", id2: "if1_un", id3: "if2_unh_ind", id0: "ant_u", property_id1: "contrast", property_id2: "", property_id3: "", question: QUESTS.if_ant, answer: ANSWERS.conditional, type: 'balance'},
  {id: "trial11", id1: "if1_un_ind", id2: "if1_un", id3: "if1_un_up", id0: "cons_n", property_id1: "contrast", property_id2: "", property_id3: "", question: QUESTS.cons, answer: ANSWERS.conditional, type: 'balance'},
  {id: "trial12", id1: "if2_unn_ind_horiz", id2: "if2_unn_horiz", id3: "if1_un_ind", id0: "ant_u", property_id1: "contrast", property_id2: "", property_id3: "", question: QUESTS.if_ant, answer: ANSWERS.conditional, type: 'balance'},
  // practice-balance
  {id: "trial13", id1: "if2_unn_ind_horiz", id2: "if2_unn_horiz", id3: "if2_unn_up_horiz", id0: "cons_n", property_id1: "contrast", property_id2: "", property_id3: "", question: QUESTS.cons, answer: ANSWERS.conditional, type: 'practice-balance'},
  {id: "trial14", id1: "if2_unn_ind_horiz", id2: "if1_un", id3: "if2_unn_horiz", id0: "ant_u", property_id1: "contrast", property_id2: "", property_id3: "", question: QUESTS.if_ant, answer: ANSWERS.conditional, type: 'practice-balance'},
  {id: "trial15", id1: "if1_un_ind", id2: "if2_unn_horiz", id3: "if2_unn_ind_horiz", id0: "cons_n", property_id1: "contrast", property_id2: "", property_id3: "", question: QUESTS.cons, answer: ANSWERS.conditional, type: 'practice-balance'},

  // control-physics trials
  {id: "trial16", id1: "if1_hn", id2: "if1_nn", id3: "if2_nnh", id0: "cons_n", property_id1: "contrast", property_id2: "", property_id3: "", question: QUESTS.neutral, answer: ANSWERS.not_both, type: 'control-physics'} ,
  {id: "trial17", id1: "if1_nn_ind", id2: "if1_nn", id3: "if1_hn", id0: "cons_n", property_id1: "contrast", property_id2: "", property_id3: "", question: QUESTS.neutral, answer: ANSWERS.both, type: 'control-physics'},
  {id: "trial18", id1: "if2_hnh", id2: "if2_nnn_horiz", id3: "if2_nnh", id0: "cons_n", property_id1: "contrast", property_id2: "", property_id3: "", question: QUESTS.neutral, answer: ANSWERS.not_yellow_cons, type: 'control-physics'},

  // filler-trials
  {id: "trial19", id1: "ind_edge_hh", id2: "ind_edge_hnh", id3: "ind_edge_hnn_horiz", id0: "ant_ind_h", property_id1: "contrast", property_id2: "", property_id3: "", question: QUESTS.neutral, answer: ANSWERS.not_cons, type: 'filler'},
  {id: "trial20", id1: "ind_edge_nn", id2: "ind_edge_nhn_horiz", id3: "ind_edge_nhh", id0: "ant_ind_n", property_id1: "contrast", property_id2: "", property_id3: "", question: QUESTS.neutral, answer: ANSWERS.cons, type: 'filler'},
  {id: "trial21", id1: "if1_nh", id2: "if1_nn_ind", id3: "if2_nnn_horiz", id0: "ant_n", property_id1: "contrast", property_id2: "", property_id3: "", question: QUESTS.neutral, answer: ANSWERS.not_both, type: 'filler'},

  // attention check trials
  //gibt es bei attention checks richtige contrast-pictures (oder macht das hier gar keinen sinn?)
  {id: "trial22", id1: "if2_nnn_horiz", id2: "if1_un_ind", id3: "if1_un", id0: "cons_n", property_id1: "contrast", property_id2: "", property_id3: "", question: QUESTS.neutral, answer: ANSWERS.might_ant, type: 'attention-check'},
  {id: "trial23", id1: "ind_edge_hh", id2: "ind_edge_hnh", id3: "ind_edge_hnn_horiz", id0: "ant_ind_h", property_id1: "contrast", property_id2: "", property_id3: "", question: QUESTS.neutral, answer: ANSWERS.not_yellow_cons, type: 'attention-check'},
  {id: "trial24", id1: "if2_unh_right", id2: "if2_nnh", id3: "if1_nn_ind", id0: "cons_n", property_id1: "", property_id2: "", property_id3: "", question: QUESTS.cons, answer: ANSWERS.yellow_cons, type: 'attention-check'},
  {id: "trial25", id1: "if2_unn_horiz", id2: "if1_uu", id3: "if1_un_ind", id0: "ant_u", property_id1: "contrast", property_id2: "", property_id3: "", question: QUESTS.if_ant, answer: ANSWERS.conditional_not, type: 'attention-check'}
];
